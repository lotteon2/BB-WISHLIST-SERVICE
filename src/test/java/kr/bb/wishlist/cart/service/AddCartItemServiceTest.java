...
class AddCartItemServiceTest {
 ...
 void AddCartItem_WhenCartItemIsAlreadyExistedInCart_StatusAlreadyExist() {
  ...
  CartEntity existingCartEntity = new CartEntity(new CartCompositeKey(1L, "1"), 2L);
  ...
  AddCartItemStatus status = addCartService.addCartItem(userId, productId, 3L);
 ...
 void AddCartItem_WhenCartItemIsNotExistedInCart_StatusNewCartItem() {
  CartEntity newCartEntity = new CartEntity(new CartCompositeKey(1L, "1"), 2L);
